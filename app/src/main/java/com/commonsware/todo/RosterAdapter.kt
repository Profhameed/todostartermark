...
class RosterAdapter(private val inflater: LayoutInflater,private val onCheckBoxToggle:(ToDoModel)-> Unit) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RosterRowHolder {
        return RosterRowHolder(TodoRowBinding.inflate(inflater, parent, false),onCheckBoxToggle)
    }
